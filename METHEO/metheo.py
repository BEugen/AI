...
pdf = pd.read_csv("C:\\RTMP\\22004.01.08.2016.01.08.2017.1.0.0.ru.ansi.00000000.csv", delimiter=';', parse_dates=True,
                  dayfirst=True)
...
pdf[[0, 1, 2, 3, 5, 8, 9, 22, 23, 30]].to_csv("C:\\RTMP\\metheo.csv", index=False, sep=';', date_format='%d.%m.%Y %H:%M')
print(pdf)
